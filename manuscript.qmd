...
# Set flextable defaults for PDF/HTML
...
params_t <- t(params)
colnames(params_t) <- params_t[1,]
params_t <- params_t[-1,]
params_dt <- as.data.table(params_t, keep.rownames = "Dataset")
...
demog_nacc |>
  kable(col.names = c("Raw MRI NACC", "Initial, N = 338", "Selected, N = 99", "p-value"),
        align = "lccc") |>
...
demog_adni |>
  kable(col.names = c("Raw MRI & Lin. Registration ADNI", "N = 10,196"),
        align = "lc") |>
  kable_styling(bootstrap_options = c("striped", "hover"),
                latex_options = c("striped", "hold_position"),
                full_width = FALSE)
...
demog_skull |>
  kable(col.names = c("Skull Segmentation ADNI", "All, N = 6,968",
                      "Subset, N = 1,746", "p-value"),
        align = "lccc") |>
  kable_styling(bootstrap_options = c("striped", "hover"),
                latex_options = c("striped", "hold_position"),
                full_width = FALSE)
...
acq_99_summ |>
  kable(col.names = c("Rater", "Total Time", "Rests",
                      "N", "Time Median (SD)", "N", "Time Median (SD)",
                      "p", "p adj."),
        align = "lclclclcc") |>
  kable_styling(bootstrap_options = c("striped", "hover"),
                latex_options = c("striped", "scale_down", "hold_position"),
                full_width = FALSE) |>
  add_header_above(c(" " = 3, "Pass" = 2, "Fail" = 2, " " = 2))
```
...
acquis_summ |>
  ...
  kable_styling(bootstrap_options = c("striped", "hover"),
                latex_options = c("striped", "scale_down", "hold_position"),
                full_width = FALSE) |>
  add_header_above(c(" " = 3, "Pass" = 2, "Fail" = 2, " " = 1))
```
...
rbindlist(list(reg_meeting, reg_meeting_all)) |>
  kable(col.names = c("Rater", "N Rated Pre-meeting", "N Changed",
                      "% Changed", "Pass to Fail", "Fail to Pass"),
        align = "lccccc") |>
  kable_styling(bootstrap_options = c("striped", "hover"),
                latex_options = c("striped", "hold_position"),
                full_width = FALSE)
